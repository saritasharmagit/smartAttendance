<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="LeaveApplication.aspx.cs" Inherits="AttendanceKantipur.User.LeaveApplication" %>
                    ...
                    <asp:UpdatePanel ID="upPnl" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="DDLEMP" CssClass="form-control" runat="server" ToolTip="Approver List" AutoPostBack="true" OnSelectedIndexChanged="DDLEMP_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-1">
                                    <asp:TextBox ID="txtEmpId" AutoPostBack="true" ReadOnly="true" CssClass="form-control" runat="server" OnTextChanged="emp_id_TextChanged"></asp:TextBox>
                                </div>
