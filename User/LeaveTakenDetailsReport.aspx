<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="LeaveTakenDetailsReport.aspx.cs" Inherits="AttendanceKantipur.User.LeaveTakenDetailsReport" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">Leave Taken Details Report
                            </li>
                        </ol>
                    ...
                    <asp:UpdatePanel ID="upPnl" runat="server" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <asp:DropDownList ID="CmbLeave" CssClass="form-control" runat="server" ToolTip="Leave List" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            </div>
