...
{
    public partial class ViewMonthlyAttendanceReport : System.Web.UI.Page
    {
        BLLSmart blu = new BLLSmart();
        string branch_name, dept_name, emp_name;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            blu.QuickAttnReport(emp_id, Startdate, Enddate, flag);
            DataTable dt = blu.Monthlyattendance(emp_id, 0, 0, Startdate, Enddate);
            ...
            lblEmployee.Text = Server.UrlDecode(Request.QueryString["emp_name"].ToString());
