<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="LeaveCancellation.aspx.cs" Inherits="AttendanceKantipur.User.LeaveCancellation" %>
            ...
            <form runat="server" role="form" class="form-horizontal">
              ...
              <asp:UpdatePanel ID="upPnl" runat="server" ChildrenAsTriggers="true" >
                ...
                <div class="form-group col-md-10">
                 ...
                 <div class="col-md-6 col-md-offset-6">
                    <div class="col-md-3">
                        <asp:Button ID="btnDelete" CssClass="btn btn-danger col-md-12" runat="server" Text="Delete" OnClick="btnDelete_Click1"/>  
                    </div>
                </div> 
