<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="QuickAttendanceReport.aspx.cs" Inherits="AttendanceKantipur.User.QuickAttendanceReport" %>
                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">QuickAttendance Report
                            </li>
                        </ol>
            ...
            <form runat="server" role="form" class="form-horizontal">
                <div class="well">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="TxtEmployee" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                        </div>
                        <label class="control-label col-md-2">Employee ID <span style="color: red">*</span></label>
                        <div class="col-md-1">
                            <asp:TextBox ID="txtEmpId" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                        </div>
