<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="Reports_LeaveInformation.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_LeaveInformation" %>
            ...
            <form runat="server" role="form" class="form-horizontal">
                ...
                <div class="well">
                    ...
                    <div class="form-group">
                       ...
                       <%--  <div class="col-sm-3">
                            <asp:CheckBox ID="ChkAttnemp" AutoPostBack="True" runat="server" OnCheckedChanged="ChkAttnemp_CheckedChanged"/><span class="lbl"> Attendance Employees</span>
                        </div> --%>        
                    </div>
                 </div>
                 </ContentTemplate>
