<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" EnableEventValidation = "false" CodeBehind="Reports_ViewEmployeeDetailInformation.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_ViewEmployeeDetailInformation" %>
			    ...
			    <div class="col-xs-12">
				    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">
                                View Employee Details Information Report
                            </li>
                        </ol>
                            ...
                            <asp:TemplateField HeaderText="Document">
                                <ItemTemplate>
                                  ...
                                  <button class="btn-rounded">
                                       <asp:LinkButton ID="OpenDocument" CommandArgument='<%# Eval("SNO") %>' Text="Download"  runat="server"></asp:LinkButton>
                                  </button>
                                </ItemTemplate>
                            </asp:TemplateField>
                             ...
                             <asp:TemplateField HeaderText="Document">
                                <ItemTemplate>
                                   <asp:Image ID="ImgDocTr" runat="server"  style="height: 50px; width: 50px ;border-style: ridge; border-width: 5px ;" ImageUrl='<%# (Eval("Image") != System.DBNull.Value ? "data:image/jpg;base64," + Convert.ToBase64String((byte[])Eval("Image")) : "../../Assets/images/PDF_logo.png") %>'  />
                                    ...
                                    <button class="btn-rounded">
                                    <asp:LinkButton ID="DocumentTraining" CommandArgument='<%# Eval("SNO") %>' Text="Download" runat="server"></asp:LinkButton>
                                </button>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Contact" HeaderText="Contact" />
                              ...
                              <asp:TemplateField HeaderText="Document">
                                ...
                                <button class="btn-rounded">
                                     <asp:LinkButton ID="DocumentWork" CommandArgument='<%# Eval("SNO") %>' Text="Download" runat="server"></asp:LinkButton>
                                </button>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
