<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/System_Setup/System_Setup.Master" AutoEventWireup="true" CodeBehind="AddDepartment.aspx.cs" Inherits="AttendanceKantipur.Admin.System_Setup.AddDepartment" %>
            ...
            <form runat="server" role="form" class="form-horizontal">
                ...
                <div class="well">
                    ...
                    <div class="form-group">                                           
                        ...
                        <div class="col-md-5">
                            <asp:RadioButton ID="rbStatus" Checked="true" GroupName="rbStatus" runat="server" OnCheckedChanged="rbStatus_CheckedChanged"/> Active
