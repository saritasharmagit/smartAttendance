<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/System_Setup/System_Setup.Master" AutoEventWireup="true" CodeBehind="AddGrade.aspx.cs" Inherits="AttendanceKantipur.Admin.System_Setup.AddGrade" %>
      ...
      <div class="content">
        <div class="container">
            ...
            <form runat="server" role="form" class="form-horizontal">
                <div class="well">
                    <asp:TextBox ID="GRADE_ID" CssClass="form-control hidden" runat="server"></asp:TextBox>
                    <div class="form-group">
                        <label class="control-label col-md-2"> Grade Name <span style="color:red">*</span></label>
                        <div class="col-md-5">
                            <asp:TextBox ID="txtGradename" CssClass="form-control" AutoComplete="off"  runat="server"></asp:TextBox> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-2"> Grade Type  <span style="color: red">*</span></label>
                        <div class="col-md-5">
                            <asp:TextBox ID="txtGradetype" CssClass="form-control" AutoComplete="off"  runat="server"></asp:TextBox> 
                        </div>
                    </div>
