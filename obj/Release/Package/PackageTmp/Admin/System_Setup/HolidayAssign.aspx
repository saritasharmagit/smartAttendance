<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/System_Setup/System_Setup.Master" AutoEventWireup="true" CodeBehind="HolidayAssign.aspx.cs" Inherits="AttendanceKantipur.Admin.System_Setup.HolidayAssign" %>
                ...
                <form runat="server" role="form" class="form-horizontal">
                    ...
                    <div class="well col-md-6">
                         <div class="form-group">
                           ...
                           <div class="col-md-5">
                                ...
                                EnableLoadOnDemand="true" EnableVirtualScrolling="true" AutoValidate="true"  AllowCustomText="true" OnSelectedIndexChanged="CmbHolidayName_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                           </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                             ...
                             <label class="control-label col-md-3"> Female only <span style="color:red">*</span></label>
                            <div class="col-md-2">
                                <asp:CheckBox ID="chkFemale" AutoPostBack="true" runat="server" OnCheckedChanged="chkFemale_CheckedChanged1"/>
                            </div>
                           </div> 
                    ...
                    <div class="header">
                     <div class="col-md-8 col-md-offset-4">
                        <div class="col-md-3">
                    <asp:Label ID="lblmsg" runat="server" Text="Details"></asp:Label> </div>
                 </div>
                    </div>
                <div class="body">
                      <asp:GridView ID="grvDetails" runat="server"
                              ...
                              <asp:TemplateField HeaderText="Select All">
                                      <HeaderTemplate>
                                           <asp:CheckBox ID="chkdetails" runat="server" Text="Select All" onclick = "checkAll(this);" />  
                               ...
                               <asp:BoundField DataField="emp_fullname" HeaderText="Emp fullname"/>   
                            </Columns>
                                <EditRowStyle/>
                                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
