...
namespace AttendanceKantipur.Admin.HR_Mgmt
{
    public partial class ShowDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int empIdd = Convert.ToInt32(lblid.Text);//for image

            int empid = Convert.ToInt32(lblid.Text);
        ...
        protected void PastWorkDownload_Click(object sender, EventArgs e)
        {
           ...
           //     {
           //         cmd.CommandText = "select Image_Name, Image from tblEmpEducation where SNO=@SNO";
