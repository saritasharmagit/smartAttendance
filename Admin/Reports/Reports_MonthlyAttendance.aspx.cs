...
{
    public partial class Reports_MonthlyAttendance : System.Web.UI.Page
    {
        ...
        protected void BtnLoad_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(String.Format("Reports_ViewMonthly.aspx?Startdate={0}&Enddate={1}&eid={2}&emp_name={3}", Server.UrlEncode(Startdate.ToString()), Server.UrlEncode(Enddate.ToString()), Server.UrlEncode(eid.ToString()), Server.UrlEncode(emp_name.ToString())));
        }
