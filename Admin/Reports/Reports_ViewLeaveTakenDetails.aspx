<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="Reports_ViewLeaveTakenDetails.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_ViewLeaveTakenDetails" %>
			    ...
			    <div class="col-xs-12">
				    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">
                                View LeaveTaken Attendance Report
                            </li>
                        </ol>
                ...
                <asp:Panel ID="Panel1" runat="server">
                     ...
                     <div style="font-weight:bold;" class="col-md-6">
                           <div style="font-weight:bold; font-size:large" >
                                    <asp:Label ID="labelleavetaken" runat="server" Text="CEAPRED Leave Taken Details Report"></asp:Label>
                                </div>
