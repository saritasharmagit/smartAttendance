<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="Reports_ViewLeaveInformation.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_ViewLeaveInformation" %>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server"  
                              ...
                              OnRowDataBound="GridView1_RowDataBound"  OnDataBound="GridView1_DataBound"  EmptyDataText="No records has been added.">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Balance"> 
                                      <ItemTemplate>
                                            <%--<asp:Label ID="Label3" runat="server" Text='<%#(Convert.ToInt32(Eval("Given")) + Convert.ToInt32(Eval("Taken")))%>'></asp:Label>--%>
                                            </ItemTemplate>
                                    </asp:TemplateField>
