<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="Reports_LateAttendance.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_LateAttendance" %>
            ...
            <form runat="server" role="form" class="form-horizontal">
                ...
                <ContentTemplate> 
                     <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <asp:CheckBox ID="Chkemp" AutoPostBack="True" runat="server" OnCheckedChanged="Chkemp_CheckedChanged"/><span class="lbl">All Attendance Employee</span>
                        </div>     
                    </div>     
                    <div class="form-group">
                        <label class="control-label col-md-2"></label>
                        <div class="col-md-5">
                            <asp:DropDownList ID="condition" CssClass="form-control" runat="server" CausesValidation="True" ToolTip="Branch List" AutoPostBack="true"
                            EnableLoadOnDemand="true" EnableVirtualScrolling="true" AutoValidate="true"  AllowCustomText="true" OnSelectedIndexChanged="condition_SelectedIndexChanged">
                                <asp:ListItem Enabled="true" Text="Select Any" Selected="true" disabled="disabled" Value="-1"></asp:ListItem>
