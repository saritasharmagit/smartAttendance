...
{
    public partial class Reports_ViewTransfer : System.Web.UI.Page
    {
        ...
        protected void CmbProject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt = blu.getTransferReport(projectid, date);
            if (dt.Rows.Count > 0)
            {
            ...
            {
                ScriptManager.RegisterStartupScript(upPnl, this.GetType(), "alertscipt", "swal('Ooops!','Employee are not transfer in this project and year!!!','warning')", true);
