<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="Reports_ViewRoosterShiftInfo.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_ViewRoosterShiftInfo" %>
        ...
        <div class="container">
			    ...
			    <div class="col-xs-12">
				    <div class="page-title-box">
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li class="active">
                                View Rooster ShiftInfo Attendance Report
                            </li>
                        </ol>
            ...
            <form runat="server" role="form" class="form-horizontal">
                <div class="col-md-12 form-group">
                    ...
                    <div style="font-weight:bold;" class="col-md-6">
                          <div style="font-weight:bold; font-size:large" >
                                    <asp:Label ID="labelrooster" runat="server" Text="CEAPRED Rooster Shift Info Report"></asp:Label>
                                </div>
                ...
                <div style="font-weight : bold;" class="col-md-12 form-group">
                    <div class="col-md-4">
                        Employee : <asp:Label ID="lblEmployee" CssClass="control-label"  runat="server" Text=""></asp:Label>
                    </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Date">
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("date","{0:MM-dd}")+"," + Eval("day")%>' ></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
