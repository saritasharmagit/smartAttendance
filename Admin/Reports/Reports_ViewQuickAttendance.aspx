<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Reports/Reports.Master" AutoEventWireup="true" CodeBehind="Reports_ViewQuickAttendance.aspx.cs" Inherits="AttendanceKantipur.Admin.Reports.Reports_ViewQuickAttendance" %>
                    ...
                    <div class="col-md-6">
                        <div style="font-weight:bold;">
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                From : <asp:Label ID="lblStartDate" runat="server" Text=""></asp:Label> To : <asp:Label ID="lblEndDate" runat="server" Text=""></asp:Label>
                            </asp:Panel>
                        </div>
                    </div>
                </div>
...
<%--                <div class="col-md-12 form-group" style="font-weight : bold;">
                    <asp:Panel ID="panel2" runat="server">
                            ...
                            Employee : <asp:Label ID="lblEmployee"  runat="server" Text=""></asp:Label> (<asp:Label ID="lblEmployeeID" runat="server" Text=""></asp:Label>)
                        </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                  ...
                                  <%--  <asp:BoundField DataField="Duty_roster" HeaderText="Duty Roster"/>--%>
                                    ...
                                    <asp:BoundField DataField="Outdiff" HeaderText="Difference" Visible="false"/>
