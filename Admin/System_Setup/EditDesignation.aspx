<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/System_Setup/System_Setup.Master" AutoEventWireup="true" CodeBehind="EditDesignation.aspx.cs" Inherits="AttendanceKantipur.Admin.System_Setup.EditDesignation" %>
   ...
   <div class="content">
            <div class="container">
                ...
                <form runat="server" role="form" class="form-horizontal">
                    <div class="well">
                          <asp:TextBox ID="DEG_ID" runat="server" Visible="False"></asp:TextBox>
                         <div class="form-group">
                            <label class="control-label col-md-2"> Employee Designation <span style="color:red">*</span></label>
                            <div class="col-md-3">
                                <asp:TextBox ID="txtDesignationemp" CssClass="form-control" runat="server"></asp:TextBox> 
                            </div>
                           </div>
