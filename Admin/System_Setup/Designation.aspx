<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/System_Setup/System_Setup.Master" AutoEventWireup="true" CodeBehind="Designation.aspx.cs" Inherits="AttendanceKantipur.Admin.System_Setup.Designation" %>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DEG_ID" HeaderText="Designation Id"/>
                                   <%-- <asp:BoundField DataField="DEG_PARENT" HeaderText="Designation Parent"/>--%>
