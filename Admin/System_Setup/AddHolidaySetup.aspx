<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/System_Setup/System_Setup.Master" AutoEventWireup="true" CodeBehind="AddHolidaySetup.aspx.cs" Inherits="AttendanceKantipur.Admin.System_Setup.AddHolidaySetup" %>
                    ...
                    <div class="well">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <asp:RadioButton ID="rbStandard"  runat="server" Text="Standard" GroupName="rbHolidayType" OnCheckedChanged="rbStandard_CheckedChanged" />
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox ID="txtnumber" Type="number" Text="1" CssClass="form-control" runat="server"></asp:TextBox> 
                            </div>
                         </div> 
                         <div class="form-group">
